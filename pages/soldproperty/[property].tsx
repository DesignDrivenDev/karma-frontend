...
const Property = ({ data, id }: { data: any; id: any }) => {
  ...
  let discount = (compensation / 100) * data.closePrice;
    ...
    <>
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-3 px-6 py-2">
            ...
            {/* <p className="font-bold">
              {data.bedroomsTotal} Beds ▪ {data.bathroomsTotalInteger} FullBaths
      ...
      <div className="min-h-screen max-w-7xl mx-auto py-8 w-11/12">
        ...
        <section className=" grid lg:grid-cols-2 gap-x-4 ">
          ...
          {/* Exterior */}
          {data.lotSizeArea && data.exteriorFeatures && data.siding ? (
...
export async function getServerSideProps(ctx: GetServerSidePropsContext) {
  ...
  const res = await fetch(
    `${url}/api/v1/properties/fetchbysoldid/${id.property}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
